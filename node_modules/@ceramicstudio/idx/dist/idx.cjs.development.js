...
var streamCaip10Link = require('@ceramicnetwork/stream-caip10-link');
var idxConstants = require('@ceramicstudio/idx-constants');
...
var IDX = /*#__PURE__*/function () {
  function IDX(_ref) {
    ...
    this._aliases = _extends({}, idxConstants.definitions, aliases);
        ...
        while (1) {
          switch (_context12.prev = _context12.next) {
            ...
            case 4:
              assertDid(did);
              _context12.next = 7;
              return streamTile.TileDocument.create(this._ceramic, null, {
                deterministic: true,
                controllers: [did],
                family: 'IDX'
              }, {
      ...
      return runtime_1.wrap(function _callee13$(_context13) {
        while (1) {
          switch (_context13.prev = _context13.next) {
            ...
            case 5:
              if (!(doc.metadata.schema !== idxConstants.schemas.IdentityIndex)) {
                _context13.next = 7;
                break;
              }
          ...
          switch (_context14.prev = _context14.next) {
            ...
            case 2:
              ...
              return doc.update(null, {
                schema: idxConstants.schemas.IdentityIndex
              });
        ...
        while (1) {
          switch (_context15.prev = _context15.next) {
            ...
            case 2:
              ...
              if (!(doc.metadata.schema !== idxConstants.schemas.Definition)) {
                _context15.next = 5;
                break;
              }
      ...
      return runtime_1.wrap(function _callee26$(_context26) {
        while (1) {
          switch (_context26.prev = _context26.next) {
            case 0:
              _context26.next = 2;
              return streamCaip10Link.Caip10Link.fromAccount(this._ceramic, accountId);
...
exports.getLegacy3BoxProfileAsBasicProfile = getLegacy3BoxProfileAsBasicProfile;
exports.isCaip10 = isCaip10;
exports.isDid = isDid;
//# sourceMappingURL=idx.cjs.development.js.map
